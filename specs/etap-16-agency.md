...
| Финальный оффер | bulk-send approved-блогерам «вы выбраны» | ✅ реализовано |
| Производство | pipeline-матрица (§16.5) | ✅ реализовано |
...
- ✅ Web: tree «Клиенты→Кампании» + карточка клиента; визард со всеми 6 фазами
  (Бриф / Лонглист / Согласование / Финальный оффер / Производство / Отчёт);
