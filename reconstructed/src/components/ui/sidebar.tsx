  ...
  (
    ...
    const setOpen = React.useCallback(
      (value: boolean | ((value: boolean) => boolean)) => {
        ...
        if (persistenceKey) {
          try {
            localStorage.setItem(persistenceKey, String(openState));
          } catch {
            // localStorage may be unavailable in sandboxed iframes
          }
        }
      },
      [setOpenProp, open, persistenceKey]
    );
      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            ...
            className={cn(
              "group/sidebar-wrapper has-[[data-variant=inset]]:bg-sidebar flex min-h-0 w-full grow",
              className
            )}
            ref={ref}
            {...props}
